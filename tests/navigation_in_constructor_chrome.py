...
assert driver.find_element(By.XPATH, '//*[@id="root"]/div/main/section[1]/div[2]/ul[2]/a[1]/p').is_displayed()
driver.quit()
...
WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, '//*[@id="root"]/div/main/section[1]/div[2]/ul[3]/a[3]/p')))
assert driver.find_element(By.XPATH, '//*[@id="root"]/div/main/section[1]/div[2]/ul[3]/a[3]/p').is_displayed()
driver.quit()
